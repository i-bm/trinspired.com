(function ($) {
    ...
    if ($(".contact-form-validated").length) {
        $(".contact-form-validated").validate({
            ...
            messages: {
                "cf-turnstile-response": {
                    required: "Please complete the Turnstile verification.",
                },
            },
            submitHandler: function (form) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $(form).parent().find(".result").remove();

                        // Create result container if it doesn't exist
                        if ($(form).parent().find(".result").length === 0) {
                            $(form)
                                .parent()
    ...
    $(window).on("load", function () {
        ...
        if ($(".testimonial-two__slider .bxslider").length) {
            $(".testimonial-two__slider .bxslider").bxSlider({
                ...
                speed: "1000",
                pagerCustom:
                    ".testimonial-two__slider .slider-pager .testimonial-two__thumb-box",
            });
        }
    });
