            ...
            <div class="col-lg-12">
                <div class="services-details__left">
                    ...
                    {{-- <div class="services-details__img">
                        <img src="{{ asset('assets/images/services/services-details-img-1.jpg') }}"
                    alt="">
                </div> --}}
                <div class="services-details__top-content">
                    <div class="row  d-flex align-items-center">
                        ...
                        <div class="col-lg-6">
                            <img src="{{ asset('assets/images/services/cloud.jpg') }}"
                                alt="Cloud Computing" class="img-fluid rounded-3 shadow">
                        </div>
                    </div>
                ...
                @foreach(cloud_use_cases() as $service)
                    <div class="row d-flex align-items-center wow fadeIn  @if($service['layout'] == 'lt-image-right') flex-row-reverse @endif"
                        ...
                        <div class="col-lg-6 p-0">
                            <a
                                href="{{ asset('assets/images/resources/' . $service['image']) }}"><img
