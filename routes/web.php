...
Route::get('/services/secure-success', [ServicesController::class, 'secure'])->name('services.secure');
...
Route::get('/services/acronis', [ServicesController::class, 'acronis'])->name('services.acronis');
